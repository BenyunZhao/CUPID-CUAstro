...
<img src="Figures/sut-crack-vis.png" width="700">

#### Benchmark Qualitative Comparison on Cross-domain Highway-Crack Dataset
<img src="Figures/highway-crack-vis.png" width="700">

#### CU-Astro: Compact but Long-duration Aerial Platform
...
### Dataset in our work can be available at: <button style="background-color: #000000; color: white; margin: 0 auto; padding: 10px 15px;border: none; border-radius: 5px;"><a href="https://mycuhk-my.sharepoint.com/:f:/g/personal/1155145791_link_cuhk_edu_hk/IgCCTYFn1undQZLWjNMbVQQHATw0Wvw7Un3ey3gJkfO1mP4?e=UKxOkp" style="color: white; text-decoration: none;">OneDrive</a> </button>, <button style="background-color: #000000; color: white; margin: 0 auto; padding: 10px 15px;border: none; border-radius: 5px;"><a href="https:baidu" style="color: white; text-decoration: none;">BaiduNet</a> </button>
